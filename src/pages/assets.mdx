...
: Kompaktes Tool zum Erstellen von Farbpaletten. Bietet alles, was du brauchst.
...
Brand Colors via [SimpleIcons](https://simpleicons.org/)
: Aktuell gepflegte Datenbank mit Farben und Logos von über 3.000 Marken.

> **Hinweis:** Viele klassische „Brand Color“-Verzeichnisse enthalten veraltete Daten (Legacy). Nutzt für finale Projekte nach Möglichkeit immer das offizielle Brand Portal der jeweiligen Marke.
...
[Form.taxi](https://form.taxi/de/backend)
: DSGVO-konforme Lösung, um Eingaben aus HTML-Formularen per E-Mail zugestellt zu bekommen.
...
[Ray.so by Racast](https://ray.so/)
: Sammlung nützlicher Tools zur Erzeugung von Code Images, Icons, Prompts, Presets, Quicklinks und Snippets.

[code.movie](https://code.movie/)
: Syntax-Highlighting für Code Snippets in animierter Form.
