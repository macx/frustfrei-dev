...
<Callout>
  Im Tutorial [Responsive Images: Art Direction im
  Kreditantrags-Prozess](/tutorials/responsive-images) lernst du, wie du Bilder
  für verschiedene Bildschirmgrößen optimierst.
</Callout>
